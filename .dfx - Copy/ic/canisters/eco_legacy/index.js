...
import { idlFactory } from './eco_legacy.did.js';
export { idlFactory } from './eco_legacy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ECO_LEGACY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./eco_legacy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the eco_legacy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./eco_legacy.did.js")._SERVICE>}
 */
export const eco_legacy = createActor(canisterId);
